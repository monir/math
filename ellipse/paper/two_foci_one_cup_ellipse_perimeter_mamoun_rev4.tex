...
formalised in the companion Lean~4 package
\textbf{Logatoms}~(9 modules, 51 named results, Mathlib~v4.28.0),
including the inductive EML tree type and its Catalan count, the
moment-signature bijection $\Phi$, the master Gamma-moment
identity, and the Heisenberg commutator $[T, D] = -I$ on the
$u$-side.  Read in the new framework, the SRIRACHA-era exponential
